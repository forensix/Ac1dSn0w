...
#define AMSVC_SYSTEM_PROFILER       CFSTR("com.apple.mobile.system_profiler")
	...
	/*edits by greysyntax*/
	unsigned int AMRecoveryModeDeviceSetAutoBoot(struct am_recovery_device *rdev, int state, int unknown1, int unknown2, int unknown3);
	unsigned int AMRecoveryModeDeviceReboot(struct am_recovery_device *rdev, int state, int unknown1, int unknown2, int unknown3);
	/*
